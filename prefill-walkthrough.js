...
/* ============================================================================
   ...
   Usage:
     node prefill-walkthrough.js https://bookit.life you+participant@gmail.com
     node prefill-walkthrough.js https://bookit.life you+participant@gmail.com --gate "site password"
     node prefill-walkthrough.js https://bookit.life you+participant@gmail.com --dry-run
...
if (!base || !email) {
  console.error('usage: node prefill-walkthrough.js https://bookit.life participant@example.com [--gate "site password"] [--dry-run]');
  process.exit(1);
}
