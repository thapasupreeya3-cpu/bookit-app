...
module.exports=function createStore(c){
 ...
 function suppress(row){
   ...
   if(meta.payment_reminder&&api.paymentDeliveryInvalid?.(meta.invoice_no))return 'Payment settled, withdrawn or under review';
