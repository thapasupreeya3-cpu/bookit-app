...
module.exports=function createStore(c){
 ...
 function projection(uid){
   ...
   if(u.role==='participant'){
     ...
     for(const b of workerBlockers(uid))if(b.key!=='paused'&&!b.key.startsWith('recruit-'))add('setup:'+b.key,'setup',b.label,b.yours?'person':'office',b.where,b.why);
 ...
 function syncOffice(){
   ...
   for(const t of api.verificationOfficeTasks?.()||[])add(t.key,t.kind,t.label,t.dest,t.detail,t.due);
