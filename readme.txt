The Care Web v88.4.19 — current-update-only archive.

Apply over v88.4.17. Extract The-Care-Web-v88.4.19-calendar-update-only.zip; merge its files at the repository root. Read UPDATE-INSTRUCTIONS.txt before updating. Preserve live runtime data.
