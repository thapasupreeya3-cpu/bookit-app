#!/usr/bin/env node
'use strict';
/* The Care Web — generate docs/api-route-inventory.txt and docs/database-table-inventory.txt
...
const src = fs.readFileSync(path.join(ROOT, 'server.js'), 'utf8')+'\n'+fs.readdirSync(path.join(ROOT,'lib')).filter(n=>/^process-.*\.js$/.test(n)).map(n=>fs.readFileSync(path.join(ROOT,'lib',n),'utf8')).join('\n');
...
const head = `# Generated by scripts/inventory.js from server.js and process modules — The Care Web v${pkg.version}. Do not edit by hand.\n`;
